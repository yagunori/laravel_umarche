                    ...
                    <div class="-m-2">
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                              ...
                              <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div>
                                        <input type="radio" name="type" class="mr-2" value="{{ \Constant::PRODUCT_LIST['add']}}" checked>追加
                                    </div>
                                    <div>
                                        <input type="radio" name="type" class="mr-2" value="{{\Constant::PRODUCT_LIST['reduce']}}" >削減
                                    </div>
                                </div>
                              </div>
                              <div class="p-2 w-1/2 mx-auto">
                      ...
                      <div class="p-2 w-1/2 mx-auto">
                        <div class="relative flex justify-around">
                            ...
                            <div>
                                <input type="radio" name="is_selling" class="mr-2" value="0" @if($product->is_selling === 0){ checked } @endif>停止中
                            </div>
                        </div>
